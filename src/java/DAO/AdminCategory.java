...
public class AdminCategory extends HttpServlet {
    ...
    for (Categories product : listC) {
        String statusParam = request.getParameter("status1_" + product.getId());
        String nameParam = request.getParameter("namecate_" + product.getId());
         boolean newStatus = statusParam != null; 
        // Debugging prints
        
        dao.updateStatusCategory(product.getId(), newStatus , nameParam);
    }
